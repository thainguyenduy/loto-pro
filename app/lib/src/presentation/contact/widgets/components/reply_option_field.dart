...
class ReplyOptionField extends StatelessWidget {
  const ReplyOptionField({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ContactFormBloc, ContactFormState>(
      builder: (context, state) {
        var controller = FormFieldController<num>(state.contact.replyMode.getOrCrash());
